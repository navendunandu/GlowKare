...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="Assets/Templates/Main/icomoon/icomoon.css">
      ...
      <div class="row justify-content-between align-items-center w-100 py-2">
        ...
        <div class="col-auto">
          <a class="navbar-brand" href="index.php">
            <img src="Assets/Templates/Main/images/main-logo.png" alt="logo">
          </a>
        </div>
              ...
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="Guest/derma.php" class="dropdown-item item-anchor">Dermatologist</a>
                    </li>
                    <li>
                      <a href="Guest/UserRegisteration.php" class="dropdown-item item-anchor">Customer</a>
                    </li>
                    <li>
                      <a href="Guest/Seller.php" class="dropdown-item item-anchor">Seller</a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a href="Guest/Login.php" class="nav-link border px-3">Login</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <!-- <div class="col-auto">
          <ul class="list-unstyled d-flex m-0 mt-3 mt-xl-0">
            <li>
              <a href="Assets/Templates/Main/wishlist.html" class="text-uppercase mx-3">
            ...
            <li>
              <a href="Assets/Templates/Main/cart.html" class="text-uppercase mx-3">
                <svg width="24" height="24" viewBox="0 0 24 24">
            ...
            <div class="container ">
              <div class="row ">
                <div class="col-md-8 offset-md-2 text-center">
                  ...
                  <p class="caption opacity-75">"Unleash your natural glow with glowKare—because your skin deserves the best!"</p>
      ...
      <div class="col-md-5 column-container">
        <div class="cat-item position-relative">
          <div class="image-holder">
            <a href="Assets/Templates/Main/shop.html"><img src="Assets/Templates/Main/images/collection-banner.jpg" alt="categories"
        ...
        <div class="col-md-4">
          <article class="post-item">
            ...
            <div class="post-content d-flex flex-wrap gap-2 my-3">
              ...
              <p>he top 10 summer makeup trends include dewy skin, bright blush, glossy lips, pastel eyeshadow, bold brows</p>
            </div>
          </article>
        </div>
        <div class="col-md-4">
  ...
  <section class="instagram my-5 py-5">
    <div class="container">
      ...
      <div class="row d-flex flex-wrap my-3 g-0">
        ...
        <figure class=" col instagram-item magnific position-relative">
          <a href="#" class="">
            <img src="Assets/Templates/Main/images/insta-item3.jpg" alt="instagram" class="insta-image">
            <div class="icon-overlay d-flex justify-content-center">
              <svg width="30" height="30" viewBox="0 0 30 30" style="color: #fff4f4;">
                <use xlink:href="#instagram"></use>
              </svg>
        ...
        <figure class=" col instagram-item magnific position-relative">
          <a href="#" class="">
            <img src="Assets/Templates/Main/images/insta-item5.jpg" alt="instagram" class="insta-image">
            <div class="icon-overlay d-flex justify-content-center">
              <svg width="30" height="30" viewBox="0 0 30 30" style="color: #fff4f4;">
                <use xlink:href="#instagram"></use>
              </svg>
      ...
      <div class="row d-flex flex-wrap justify-content-between py-5">
        <div class="col-md-4 col-sm-6">
          <div class="footer-menu footer-menu-001">
            ...
            <p>“Experience the magic of glowKare – where every drop reveals your skin’s true radiance.”</p>
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="Assets/Templates/Main/images/arct-icon.png" alt="icon">
              <img src="Assets/Templates/Main/images/dhl-logo.png" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img src="Assets/Templates/Main/images/visa-card.png" alt="card">
              <img src="Assets/Templates/Main/images/paypal-card.png" alt="card">
              <img src="Assets/Templates/Main/images/master-card.png" alt="card">
            </div>
          </div>
          <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <p>© Copyright 2023. All rights reserved. Design by <a href="https://templatesjungle.com"

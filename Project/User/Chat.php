...
$sel = "select * from tbl_derma where derma_id ='".$_GET["id"]."'";
               $res = $Con->query($sel);
                $row=$res->fetch_assoc();
?>
    <!DOCTYPE html>
    ...
    <body>
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="../Assets/Files/derma/Photo/<?php echo $row["derma_photo"] ?>" alt="">
                            </div>
                            <div class="username">
                                <span><?php echo $row["derma_name"] ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="nav-end">
        ...
        <script>
                                    ...
                                    function sendChat(id)
                                    {
                                        ...
                                        {
                                            alert("Character Length less Than 900 Allowed");
                                            document.getElementById("msg").value = "";

      ...
      <div class="row justify-content-between align-items-center w-100 py-2">
        ...
        <div class="col-auto">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="Booking.php" class="dropdown-item item-anchor">Orders</a>
                    </li>
                    <li>
                      <a href="MyComplaints.php" class="dropdown-item item-anchor">Complaints</a>
                    </li>
</ul>
                    <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="dropdownShop" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Consult</a>
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="Dermatologist.php" class="dropdown-item item-anchor">Search</a>
                    </li>
                    <li>
                      <a href="ChatList.php" class="dropdown-item item-anchor">Chat</a>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
              <li class="nav-item">
                  <a class="nav-link" href="../Guest/LogOut.php">LogOut</a>
                </li></ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-auto">
          <ul class="list-unstyled d-flex m-0 mt-3 mt-xl-0">
            ...
            <li>
              <a href="MyCart.php" class="text-uppercase mx-3">
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <use xlink:href="#cart"></use>
                </svg>
                <span class="cart-count">(
                  <?php
                  $cart="select count(*) as count from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id where booking_status = 0 and user_id=".$_SESSION['uid'];
                  $res=$Con->query($cart);
            ...
            <li class="search-box">
              <a href="SearchProduct.php" class="search-button mx-3">

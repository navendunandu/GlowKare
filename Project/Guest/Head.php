              ...
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="derma.php" class="dropdown-item item-anchor">Dermatologist</a>
                    </li>
                    <li>
                      <a href="UserRegisteration.php" class="dropdown-item item-anchor">Customer</a>
                    </li>
                    <li>
                      <a href="Seller.php" class="dropdown-item item-anchor">Seller</a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a href="Login.php" class="nav-link border px-3">Login</a>
                </li>
              </ul>
            </div>
          </div>

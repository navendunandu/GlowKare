...
if(isset($_POST["btn_register"]))
{
	...
	move_uploaded_file($tmpphoto, '../Assets/Files/Derma/Photo/'.$photo);
	$proof=$_FILES['file_proof']['name'];
	$tmpproof=$_FILES['file_proof']['tmp_name'];
	move_uploaded_file($tmpproof, '../Assets/Files/Derma/Proof/'.$proof);
	$password= $_POST['txt_password'];
	$confirmpassword=$_POST['txt_confirm'];
	...
	if($resUser->num_rows>0 || $resAdmin->num_rows>0 || $resDerma->num_rows>0){
		?>
		  <script>
	  ...
	  $InsQry = "insert into tbl_derma(derma_name,derma_email,derma_address,place_id,derma_photo,derma_proof,derma_password,derma_doj,derma_contact)values('$name','$email','$address','$place','$photo','$proof','$password',curdate(),'$contact')";
    ...
    $mail->Password = 'rgz jwwx pwhh oequ'; // Your gmail app password
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="txt_address" required  id="txt_address" rows="3"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="sel_district" required id="sel_district" onchange="getPlace(this.value)">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" required name="sel_place" id="sel_place">
                                            <option>--Select--</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="file_photo" class="form-label">Photo</label>
                                        <input class="form-control" type="file" required name="file_photo" id="file_photo" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="file_proof" class="form-label">Proof</label>
                                        <input class="form-control" type="file" required name="file_proof" id="file_proof" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="txt_password" class="form-label">Password</label>
                                        <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" class="form-control" required name="txt_password" id="txt_password" />
                                    </div>
                                    <div class="mb-3">
                                        <label for="txt_confirm" class="form-label">Confirm Password</label>
                                        <input type="password" class="form-control" required name="txt_confirm" id="txt_confirm" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">

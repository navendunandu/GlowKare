      ...
      <div class="row justify-content-between align-items-center w-100 py-2">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <li>
                      <a href="AddProducts.php" class="dropdown-item item-anchor">View</a>
                    </li>
                    <li>
                      <a href="Booking.php" class="dropdown-item item-anchor">Orders</a>
                    </li>
                    <li>
                      <a href="Stock.php" class="dropdown-item item-anchor">Stock</a>
                    </li>
                    <li>
                      <a href="Product.php" class="dropdown-item item-anchor">Add</a>
                    </li>
</ul>
                    <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="dropdownShop" data-bs-toggle="dropdown"
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="Complaints.php" class="dropdown-item item-anchor">View </a>
                    </li>
                    <li>
                      <a href="Reply.php" class="dropdown-item item-anchor">Reply</a>
                    </li>
                  </ul>
                </li>
        ...
        <div class="col-auto">
          <ul class="list-unstyled d-flex m-0 mt-3 mt-xl-0">
            ...
            <li class="search-box">
              <a href="ProductSearch.php" class="search-button mx-3">
